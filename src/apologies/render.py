...
# noinspection PyDictCreation
_START = {}
_START[PlayerColor.RED] = [1281, 1283, 1285, 1287]
_START[PlayerColor.BLUE] = [2416, 2418, 2420, 2422]
_START[PlayerColor.YELLOW] = [7145, 7147, 7149, 7151]
_START[PlayerColor.GREEN] = [6010, 6012, 6014, 6016]
...
# noinspection PyDictCreation
_SAFE = {}
_SAFE[PlayerColor.RED] = [864, 1435, 1989, 2526, 3063]
_SAFE[PlayerColor.BLUE] = [1529, 1524, 1519, 1514, 1509]
_SAFE[PlayerColor.YELLOW] = [7747, 7176, 6622, 6085, 5548]
_SAFE[PlayerColor.GREEN] = [7082, 7087, 7092, 7097, 7102]
...
# noinspection PyDictCreation
_HOME = {}
_HOME[PlayerColor.RED] = [3708, 3710, 3712, 3714]
_HOME[PlayerColor.BLUE] = [1318, 1320, 1322, 1324]
_HOME[PlayerColor.YELLOW] = [4735, 4737, 4739, 4741]
_HOME[PlayerColor.GREEN] = [7108, 7110, 7112, 7114]
