...
htmlhelp_basename = "apologiesdoc"
...
latex_documents = [
    ("index", "Apologies.tex", "Apologies Documentation", "Apologies", "manual"),
]
...
man_pages = [("index", "apologiestemplate", "Apologies Documentation", ["Apologies"], 1)]
